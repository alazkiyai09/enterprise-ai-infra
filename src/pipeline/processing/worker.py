...
from src.pipeline.storage.database import get_db_manager
from src.pipeline.storage.models import EventRecord, ProcessingStatus
from src.pipeline.storage.repositories import EventRepository, StatusRepository
...
async def _update_vector_store_async(
    ...
    Returns:
        List of vector IDs
    """
    from src.pipeline.storage.vector_store import get_vector_store
