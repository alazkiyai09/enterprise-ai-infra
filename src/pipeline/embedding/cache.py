...
from src.pipeline.storage.models import EmbeddingCache
from src.pipeline.storage.repositories import EmbeddingCacheRepository
...
class HybridEmbeddingCache:
    ...
    def __init__(
        ...
        """
        from src.pipeline.embedding.generator import EmbeddingCache
